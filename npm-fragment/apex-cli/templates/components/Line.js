 ...
 */
export default function Line({ animateOnScroll = false, delay = 0, className = "", forceReady, duration = 1.2, }) {
    ...
    return (_jsx("div", { ref: lineRef, className: `h-px bg-[var(--text-secondary)]/50 ${className}`, style: { opacity: isReady ? 1 : 0 } }));
}

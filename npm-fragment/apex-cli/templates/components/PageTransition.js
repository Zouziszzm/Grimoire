...
const PageTransition = ({ children }) => {
        ...
        if (isFirstLoad) {
            ...
            if (logoOverlayRef.current) {
                ...
                function exitSequence() {
                    ...
                    const digits = document.querySelectorAll(".slot .digit, .slot .percent-symbol");
                    exitTl.to(digits, {
                        x: "-105%",
                        duration: 0.8,
                        stagger: 0.05,
                    ...
                    exitTl.to([logoOverlayRef.current], {
                        opacity: 0,
                        duration: 0.8,
                        ease: "power2.inOut",
                    }, "<");
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { ref: overlayRef, className: "transition-overlay" }), _jsx("div", { ref: logoOverlayRef, className: "logo-overlay bg-[#D4CFCB]", children: _jsx("div", { className: "logo-container mb-20", children: _jsx(Svg, { paths: paths, ref: logoRef, className: "text-[var(--text-primary)]" }) }) }), children] }));
};
